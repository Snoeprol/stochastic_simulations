...
CHARGES = 5
PI = np.pi
TAU_3 = np.array([[0.001, 0], [0, 0.001]])


class TemperatureList:
    """
    Creates the initial list for the LBSA
    ...
    def move(self):
        ...
        rad = np.sqrt(x ** 2 + y ** 2)
        change = np.random.multivariate_normal([0, 0], TAU_3)
        temp_x, temp_y = (
    ...
    def generate_temperature(self):
        """
        Generates the initial temperature list
        """
